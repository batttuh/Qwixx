...
class _GameViewState extends State<GameView> with TickerProviderStateMixin {
  ...
  void shake() {
    ShakeDetector detector = ShakeDetector.autoStart(
      onPhoneShake: () {
        Provider.of<EightSideDiceController>(context, listen: false).rollDice(
            isTimeFinished,
            isRolled,
            timeSetted,
            _animationControllerTimer,
            widget.side);
      },
    );
  }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: timeSetted
            ...
            : Text(localizor.tr(LocaleKeys.goodLuck)),
        leading: IconButton(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              Provider.of<EightSideDiceController>(context, listen: false)
                  .enableAllDice();
              isRolled = false;
              setState(() {
          ...
          child: Container(
            ...
            child: Column(children: [
              ...
              Flexible(
                flex: 2,
                child: Row(children: [
                  Provider.of<EightSideDiceController>(context, listen: true)
                          .dices[2]
                          .enable
                      ? Flexible(
                          fit: FlexFit.tight,
                          child: InkWell(
                              onTap: () => Provider.of<EightSideDiceController>(
                                      context,
                                      listen: false)
                                  .disableDice(2),
                  ...
                  Provider.of<EightSideDiceController>(context, listen: false)
                      ...
                      ? Flexible(
                          ...
                          child: InkWell(
                              onTap: () {
                                Provider.of<EightSideDiceController>(context,
                                        listen: false)
                                    .disableDice(3);
                                setState() {}
                              },
              ...
              Flexible(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Provider.of<EightSideDiceController>(context, listen: false)
                        .rollDice(isTimeFinished, isRolled, timeSetted,
                            _animationControllerTimer, widget.side);
                  ...
                  child: Text(localizor.tr(LocaleKeys.roll)),
                ),
              ),
            ]),
          ),
